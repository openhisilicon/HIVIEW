...
#define is_yuv_sp422(pixel_format)  ((pixel_format) == PIXEL_FORMAT_YUV_SEMIPLANAR_422)
#define is_yvu_sp422(pixel_format)  ((pixel_format) == PIXEL_FORMAT_YVU_SEMIPLANAR_422)
#define is_yuv_sp420(pixel_format)  ((pixel_format) == PIXEL_FORMAT_YUV_SEMIPLANAR_420)
#define is_yvu_sp420(pixel_format)  ((pixel_format) == PIXEL_FORMAT_YVU_SEMIPLANAR_420)
#define is_yuv_400(pixel_format)    ((pixel_format) == PIXEL_FORMAT_YUV_400)
#define is_sp422(pixel_format)      (is_yuv_sp422(pixel_format) || is_yvu_sp422(pixel_format))
#define is_sp420(pixel_format)      (is_yuv_sp420(pixel_format) || is_yvu_sp420(pixel_format))
