...
typedef struct hiISP_RADIAL_SHADING_TABLE_S {
    HI_U8   u16RadialScale;       /* RW; Range:[0, 13];Format:4.0;Four bit value that selects the scale and precision
                                      for the 10 bit gain coefficients */
    HI_U16  u16CenterX;    /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Width], shows x value of the position
                              of optical center */
    HI_U16  u16CenterY;    /* RW; Range:[0, 65535];Format:16.0;Limited Range:[0, Height], shows y value of the position
                              of optical center */
...
typedef struct hiISP_TUNNEL_INFO_S {
    ISP_TUNNEL_ROI_S  stROI[TUNNEL_CLASS_MAX];
} ISP_TUNNEL_INFO_S;
