...
int SAMPLE_IR_AUTO_Thread(int argc,char* argv[])
{
    ...
    if (SAMPLE_IR_CALIBRATION_MODE == u32Mode)
    {
        ...
        u32RG = ((HI_U32)stStat.u16GlobalR << 8) / SNS_DIV_0_TO_1(stStat.u16GlobalG);
        u32BG = ((HI_U32)stStat.u16GlobalB << 8) / SNS_DIV_0_TO_1(stStat.u16GlobalG);
