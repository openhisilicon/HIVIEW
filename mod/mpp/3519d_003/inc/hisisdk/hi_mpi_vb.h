...
hi_s32 hi_mpi_vb_get_common_pool_id(hi_vb_common_pools_id *pools_id);
hi_s32 hi_mpi_vb_get_mod_common_pool_id(hi_vb_uid vb_uid, hi_vb_common_pools_id *pools_id);

hi_s32 hi_mpi_vb_pool_share(hi_vb_pool pool, hi_s32 pid);
hi_s32 hi_mpi_vb_pool_unshare(hi_vb_pool pool, hi_s32 pid);
hi_s32 hi_mpi_vb_pool_share_all(hi_vb_pool pool);
hi_s32 hi_mpi_vb_pool_unshare_all(hi_vb_pool pool);
