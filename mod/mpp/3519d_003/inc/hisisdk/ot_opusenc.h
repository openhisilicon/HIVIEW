...
#define OT_OPUSENC_MAX_IN_SAMPLES 480 /* opus max input samples per-frame, per-channel */
...
td_s32 ot_opusenc_process_frame(ot_opus_encoder encoder, td_s16 *in_buf, td_u8 *out_buf, td_u32 *out_valid_len);
