...
typedef enum {
    ...
    OT_TDE_COLOR_FORMAT_JPG_YCbCr422MBHP,   /* 44：SP422h(1*2)(像素宽度为偶数) */
    OT_TDE_COLOR_FORMAT_JPG_YCbCr422MBVP,   /* 45：SP422V(2*1)(像素高度为偶数) */
    OT_TDE_COLOR_FORMAT_MP1_YCbCr420MBP,    /* 46：SP420(cd hi像素宽高为偶数) */
    OT_TDE_COLOR_FORMAT_MP2_YCbCr420MBP,    /* 47：SP420(cd hi像素宽高为偶数) */
    OT_TDE_COLOR_FORMAT_MP2_YCbCr420MBI,    /* 48：SP420(cd hi像素宽高为偶数) */
    OT_TDE_COLOR_FORMAT_JPG_YCbCr420MBP,    /* 49：SP420(cd hi像素宽高为偶数) */
    OT_TDE_COLOR_FORMAT_JPG_YCbCr444MBP,    /* 50：SP444(cd hi像素宽高为偶数) */
