...
typedef struct {
    ...
    td_s32 min_gain;    /* minimum gain, default:10, range:[0, 100] */
    td_s32 threshold;   /* howling suppressor threshold, default:2, range:[0, 10] */
