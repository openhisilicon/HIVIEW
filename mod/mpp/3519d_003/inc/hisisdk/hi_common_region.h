...
#ifndef HI_COMMON_REGION_H
#define HI_COMMON_REGION_H
...
#define HI_RGN_LINEEX OT_RGN_LINEEX
#define HI_RGN_MOSAIC OT_RGN_MOSAIC
#define HI_RGN_MOSAICEX OT_RGN_MOSAICEX
#define HI_RGN_CORNER_RECT OT_RGN_CORNER_RECT
...
typedef ot_rgn_lineex_chn_attr hi_rgn_lineex_chn_attr;
typedef ot_rgn_corner_rect_chn_attr hi_rgn_corner_rect_chn_attr;
typedef ot_rgn_corner_rectex_chn_attr hi_rgn_corner_rectex_chn_attr;
