...
typedef enum {
    ...
    HI_TDE_COLOR_FORMAT_MP2_YCbCr420MBI,  /* Semi-planar YUV400 format */
    HI_TDE_COLOR_FORMAT_JPG_YCbCr420MBP,  /* Semi-planar YUV400 format, for JPG decoding */
...
typedef enum {
    ...
    HI_TDE_MB_COLOR_FORMAT_MP2_YCbCr420MBI,  /* Semi-planar YUV400 format */
    HI_TDE_MB_COLOR_FORMAT_JPG_YCbCr420MBP,  /* Semi-planar YUV400 format, for JPG pictures */
