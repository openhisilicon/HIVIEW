 ...
 * Description: hdr common header file
...
typedef struct hiHDR_TM_PARAM_S {
    ...
    HDR_TM_CUBIC_ATTR_S astCubicPoint[HDR_TM_CUBIC_NUM]; /* RW; Points parameters used to draw TM cubic curve */
