...
typedef struct hiVI_FUSION_CORRECTION_S
{
    HI_BOOL  bCorrect;
    HI_S64   as64CorrectionCoef[GDC_FUSION_NUM];  
    RECT_S   stRegion; 
} VI_FUSION_CORRECTION_S;

typedef struct hiVI_FUSION_GROUP_ATTR_S
{
    HI_BOOL      bFusionEn;
    HI_U32       u32PipeNum; 
    VI_PIPE      PipeId[VI_MAX_PIPE_NUM];
    VI_FUSION_CORRECTION_S  stCorrection;
} VI_FUSION_GROUP_ATTR_S;
