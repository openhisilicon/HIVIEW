...
{
    HI_U8   u8DetailSmoothRange;   /*RW; Range:Hi3559AV100 = [0x1, 0x8] | Hi3519AV100 = [0x1, 0x7] ;   Format:4.0;   Fine strength for noise suppressing*/
    HI_U8   u8NonDirDetailEhcStr;  /*RW; Range:[0x0,0x7F];  Format:3.4;   Non-direction detail enhance strength, Only used for Hi3519AV100*/
    HI_U8   u8NonDirStr;           /*RW; Range:[0x0, 0xFF]; Format:4.4;   Non-direction strength, Only used for Hi3519AV100*/
...
{
    HI_U8   au8DetailSmoothRange[ISP_AUTO_ISO_STRENGTH_NUM];   /*RW; Range:Hi3559AV100 = [0x1, 0x8] |Hi3519AV100 = [0x1, 0x7] ;   Format:4.0;   Fine strength for noise suppressing*/
    HI_U8   au8NonDirDetailEhcStr[ISP_AUTO_ISO_STRENGTH_NUM];  /*RW; Range:[0x0,0x7F];  Format:3.4;   Non-direction detail enhance strength, Only used for Hi3519AV100*/
    HI_U8   au8NonDirStr[ISP_AUTO_ISO_STRENGTH_NUM];           /*RW; Range:[0x0, 0xFF]; Format:4.4;   Non-direction strength, Only used for Hi3519AV100*/
