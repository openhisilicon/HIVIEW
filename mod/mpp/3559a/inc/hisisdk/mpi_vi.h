...
HI_S32 HI_MPI_VI_SetFusionGroupAttr (VI_PIPE ViPipe, const VI_FUSION_GROUP_ATTR_S *pstFusionGroupAttr);
HI_S32 HI_MPI_VI_GetFusionGroupAttr (VI_PIPE ViPipe, VI_FUSION_GROUP_ATTR_S *pstFusionGroupAttr);
