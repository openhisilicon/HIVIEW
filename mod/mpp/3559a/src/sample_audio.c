...
HI_S32 SAMPLE_AUDIO_AiVqeProcessAo(HI_VOID)
{
    ...
    AI_TALKVQE_CONFIG_S stAiTalkVqeAttr;
    ...
    else if(2 == u32AiVqeType)
    {
        ...
        stAioAttr.enSoundmode    = AUDIO_SOUND_MODE_MONO;
        stAioAttr.u32ChnCnt      = 1;
        memset(&stAiTalkVqeAttr, 0, sizeof(AI_TALKVQE_CONFIG_S));
        stAiTalkVqeAttr.s32WorkSampleRate    = stAioAttr.enSamplerate;
        stAiTalkVqeAttr.s32FrameSample       = SAMPLE_AUDIO_PTNUMPERFRM;
        stAiTalkVqeAttr.enWorkstate          = VQE_WORKSTATE_COMMON;
        stAiTalkVqeAttr.stAecCfg.bUsrMode    = HI_FALSE;
        stAiTalkVqeAttr.stAnrCfg.bUsrMode    = HI_FALSE;
        stAiTalkVqeAttr.stAgcCfg.bUsrMode    = HI_FALSE;
        stAiTalkVqeAttr.stHpfCfg.bUsrMode    = HI_TRUE;
        stAiTalkVqeAttr.stHpfCfg.enHpfFreq   = AUDIO_HPF_FREQ_80;

        stAiTalkVqeAttr.u32OpenMask = AI_TALKVQE_MASK_HPF | AI_TALKVQE_MASK_ANR | AI_TALKVQE_MASK_AGC;

        pAiVqeAttr = (HI_VOID *)&stAiTalkVqeAttr;

        memset(&stAoVqeAttr, 0, sizeof(AO_VQE_CONFIG_S));
        stAoVqeAttr.s32WorkSampleRate    = stAioAttr.enSamplerate;
        ...
        stAoVqeAttr.u32OpenMask = AO_VQE_MASK_HPF | AO_VQE_MASK_ANR | AO_VQE_MASK_AGC;
