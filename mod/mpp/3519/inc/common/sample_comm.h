...
//maohw add;
#define SAMPLE_AUDIO_INNER_AI_DEV SAMPLE_AUDIO_AI_DEV
#define SAMPLE_AUDIO_INNER_AO_DEV SAMPLE_AUDIO_AO_DEV
#define SAMPLE_AUDIO_INNER_HDMI_AO_DEV SAMPLE_AUDIO_AO_DEV
