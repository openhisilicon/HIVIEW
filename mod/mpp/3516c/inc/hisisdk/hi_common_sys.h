...
#ifndef HI_COMMON_SYS_H
#define HI_COMMON_SYS_H
...
#define HI_COEF_LEVEL_19 OT_COEF_LEVEL_19
...
#define HI_VI_AIISP_MODE_DEFAULT OT_VI_AIISP_MODE_DEFAULT
#define HI_VI_AIISP_MODE_AIDRC OT_VI_AIISP_MODE_AIDRC
#define HI_VI_AIISP_MODE_AIDM OT_VI_AIISP_MODE_AIDM
#define HI_VI_AIISP_MODE_AI3DNR OT_VI_AIISP_MODE_AI3DNR
#define HI_VI_AIISP_MODE_BUTT OT_VI_AIISP_MODE_BUTT
typedef ot_vi_aiisp_mode hi_vi_aiisp_mode;
...
typedef ot_vpss_venc_wrap_param hi_vpss_venc_wrap_param;
typedef ot_vi_slave_wrap_param hi_vi_slave_wrap_param;
typedef ot_vi_pipe_wrap_param hi_vi_pipe_wrap_param;
typedef ot_vi_wrap_in_param hi_vi_wrap_in_param;
typedef ot_vi_wrap_out_param hi_vi_wrap_out_param;

#ifdef __cplusplus
}
#endif
#endif /* HI_COMMON_SYS_H */
