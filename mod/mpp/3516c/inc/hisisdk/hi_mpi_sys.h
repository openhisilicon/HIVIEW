...
hi_s32 hi_mpi_sys_start_sync_frame_rate_ctrl(const hi_mpp_chn *src_chn, const hi_mpp_chn *dst_chn);
hi_s32 hi_mpi_sys_stop_sync_frame_rate_ctrl(const hi_mpp_chn *src_chn, const hi_mpp_chn *dst_chn);

hi_s32 hi_mpi_sys_get_vpss_venc_wrap_buf_line(const hi_vpss_venc_wrap_param *param, hi_u32 *buf_line);
hi_s32 hi_mpi_sys_get_vi_wrap_buffer_line(const hi_vi_wrap_in_param *in_param, hi_vi_wrap_out_param *out_param);
