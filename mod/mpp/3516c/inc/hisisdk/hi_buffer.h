...
__inline static hi_u32 hi_comm_get_vpss_venc_wrap_buf_size(const hi_pic_buf_attr *buf_attr, hi_u32 buf_line)
{
    return ot_comm_get_vpss_venc_wrap_buf_size(buf_attr, buf_line);
}
...
__inline static hi_u32 hi_venc_get_svc_mask_size(hi_u32 width, hi_u32 height)
{
    return ot_venc_get_svc_mask_size(width, height);
}
