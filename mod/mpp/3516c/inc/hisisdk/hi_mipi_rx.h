...
#define HI_ERR_MIPIRX_INVALID_PORT_ID OT_ERR_MIPIRX_INVALID_PORT_ID
#define HI_ERR_MIPIRX_INVALID_LANE_ID OT_ERR_MIPIRX_INVALID_LANE_ID
#define HI_ERR_MIPIRX_ILLEGAL_PARAM OT_ERR_MIPIRX_ILLEGAL_PARAM
#define HI_ERR_MIPIRX_NULL_PTR OT_ERR_MIPIRX_NULL_PTR
#define HI_ERR_MIPIRX_NOT_SET_LANE_MODE OT_ERR_MIPIRX_NOT_SET_LANE_MODE
#define HI_ERR_MIPIRX_MODE_NOT_SUPPORT OT_ERR_MIPIRX_MODE_NOT_SUPPORT
#define HI_ERR_MIPIRX_FAILED_MALLOC OT_ERR_MIPIRX_FAILED_MALLOC
#define HI_ERR_MIPIRX_BAD_IOREMAP OT_ERR_MIPIRX_BAD_IOREMAP
