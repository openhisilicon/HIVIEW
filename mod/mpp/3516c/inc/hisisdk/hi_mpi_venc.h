...
hi_s32 hi_mpi_venc_send_frame_batch_crop(hi_venc_chn chn, const hi_venc_frame_batch_crop_info *frame, hi_s32 milli_sec);
hi_s32 hi_mpi_venc_send_qpmap(hi_venc_chn chn, const hi_venc_user_qpmap *qpmap);
...
hi_s32 hi_mpi_venc_set_jpeg_roi_adv_attr(hi_venc_chn chn, const hi_venc_jpeg_roi_adv_attr *roi_adv_attr);
hi_s32 hi_mpi_venc_get_jpeg_roi_adv_attr(hi_venc_chn chn, hi_u32 idx, hi_venc_jpeg_roi_adv_attr *roi_adv_attr);
...
hi_s32 hi_mpi_venc_set_svc_param_ex(hi_venc_chn chn, const hi_venc_svc_param_ex *svc_param_ex);
hi_s32 hi_mpi_venc_get_svc_param_ex(hi_venc_chn chn, hi_venc_svc_param_ex *svc_param_ex);
hi_s32 hi_mpi_venc_send_svc_region(hi_venc_chn chn, const hi_venc_svc_rect_info *svc_region);
hi_s32 hi_mpi_venc_send_svc_mask(hi_venc_chn chn, const hi_venc_svc_mask_info *svc_mask);
...
hi_s32 hi_mpi_venc_set_svac3_trans(hi_venc_chn chn, const hi_venc_svac3_trans *svac3_trans);
hi_s32 hi_mpi_venc_get_svac3_trans(hi_venc_chn chn, hi_venc_svac3_trans *svac3_trans);
hi_s32 hi_mpi_venc_set_svac3_dblk(hi_venc_chn chn, const hi_venc_svac3_dblk *svac3_dblk);
hi_s32 hi_mpi_venc_get_svac3_dblk(hi_venc_chn chn, hi_venc_svac3_dblk *svac3_dblk);
hi_s32 hi_mpi_venc_set_svac3_sao(hi_venc_chn chn, const hi_venc_svac3_sao *svac3_sao);
hi_s32 hi_mpi_venc_get_svac3_sao(hi_venc_chn chn, hi_venc_svac3_sao *svac3_sao);
hi_s32 hi_mpi_venc_set_svac3_emulation(hi_venc_chn chn, const hi_venc_svac3_emulation *emulation);
hi_s32 hi_mpi_venc_get_svac3_emulation(hi_venc_chn chn, hi_venc_svac3_emulation *emulation);
hi_s32 hi_mpi_venc_enable_one_pack(hi_venc_chn chn, hi_bool enable);
