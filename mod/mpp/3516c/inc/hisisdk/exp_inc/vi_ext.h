...
typedef td_s32  fn_vi_set_pipe_bnr_en(ot_vi_pipe vi_pipe, td_bool bnr_en, td_bool bnr_ctrl_en);
...
#define call_vi_set_pipe_bnr_en(vi_pipe, bnr_en, bnr_ctrl_en) \
    func_entry(vi_export_func, OT_ID_VI)->pfn_vi_set_pipe_bnr_en(vi_pipe, bnr_en, bnr_ctrl_en)
...
td_s32 mpi_vi_set_slave_sync_time(ot_vi_pipe vi_pipe, td_u32  slave_mode_time);
