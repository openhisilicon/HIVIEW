...
/*
 *   Prototype    : hi_mpi_ive_get_perspective_transform
 *   Description  : Get perspective transform
 *   Parameters   : hi_svp_src_img              *src           The input source.Only the U8C1/YUVSP420/YUVSP422.
 *                                                             input format is supported.
 *                  hi_svp_rect_u32             roi[]          Roi array.
 *                  hi_ive_warp_perspective_points points[]    Point pair array.
 *                  hi_svp_src_mem_info         inverse_matrix Inverse matrix.
 *                  hi_svp_dst_img              dst[]          Output result.Only the U8C1/YUVSP420/YUVSP422
 *                                                             format is supported.
 *                  hi_ive_warp_perspective_transform_ctrl*ctrl   Perspective transform control parameter.
 *   Return Value : HI_SUCCESS: Success;Error codes: Failure.
 *   Date         : 2024-03-05
 *   Author       : Multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_get_perspective_transform(const hi_svp_src_img  *src, const hi_svp_rect_u32 roi[],
    const hi_ive_warp_perspective_points points[],  const hi_svp_dst_mem_info *inverse_matrix,
    const hi_ive_warp_perspective_transform_ctrl *ctrl);
/*
 *   Prototype    : hi_mpi_ive_warp_perspective
 *   Description  : Perspective transform
 *   Parameters   : hi_ive_handle               *handle        Returned handle ID of a task.
 *                  hi_svp_src_img              *src           The input source.Only the U8C1/YUVSP420/YUVSP422
 *                                                             input format is supported..
 *                  hi_svp_rect_u32             roi[]          Roi array.
 *                  hi_svp_src_mem_info         inverse_matrix Inverse matrix.
 *                  hi_svp_dst_img              dst[]          Output result.Only the U8C1/YUVSP420/YUVSP422
 *                                                             format is supported.
 *                  hi_ive_warp_perspective_ctrl*ctrl          PerspTrans control parameter.
 *                  hi_bool                     is_instant     For details, see hi_mpi_ive_dma.
 *   Return Value : HI_SUCCESS: Success;Error codes: Failure.
 *   Date         : 2024-03-05
 *   Author       : Multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_warp_perspective(hi_ive_handle *handle, const hi_svp_src_img *src,
    const hi_svp_rect_u32 roi[], const hi_svp_src_mem_info *inverse_matrix,
    const hi_svp_dst_img dst[], const hi_ive_warp_perspective_ctrl *ctrl, hi_bool is_instant);
/*
...
/*
 *   Prototype    : hi_mpi_ive_alpha_blending
 *   Description  : Two gray images Add operation by each pixel weight.
 *   Parameters   : hi_ive_handle        *handle     Returned handle ID of a task
 *                  hi_svp_src_img       *src1       Augend of the input source.Only the U8C1 input format is supported.
 *                  hi_svp_src_img       *src2       Addend of the input source.Only the U8C1 input format is supported.
 *                  hi_svp_src_img       *alpha      Weight.Only the U8C1 input format is supported.
 *                  hi_svp_dst_img       *dst        Output result of src1 plus src2.
 *                  hi_bool              is_instant    For details, see hi_mpi_ive_dma.
 *   Return Value : HI_SUCCESS: Success;Error codes: Failure.
 *   Date         : 2024-03-05
 *   Author       : Multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_alpha_blending(hi_ive_handle *handle, const hi_svp_src_img *src1, const hi_svp_src_img *src2,
    const hi_svp_src_img *alpha, const hi_svp_dst_img *dst, hi_bool is_instant);
 
/*
 *   Prototype    : hi_mpi_ive_acc
 *   Description  : Two gray images accumulation operation.
 *   Parameters   : hi_ive_handle        *handle     Returned handle ID of a task
 *                  hi_svp_src_img       *src1       Augend of the input source.Only the U8C1 input format is supported.
 *                  hi_svp_src_img       *src2       Addend of the input source.Only the U8C1 input format is supported.
 *                  hi_svp_dst_img       *dst        Output result of src1 plus src2.
 *                  hi_ive_acc_ctrl      *ctrl       ctrl.
 ...
 *   Author       : Multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_acc(hi_ive_handle *handle, const hi_svp_src_img *src1, const hi_svp_src_img *src2,
    const hi_svp_dst_img *dst, const hi_ive_acc_ctrl *ctrl, hi_bool is_instant);
 
/*
 *   Prototype    : hi_mpi_ive_image_dot
 *   Description  : Two images dot product operation.
 *   Parameters   : hi_ive_handle    *handle Returned handle ID of a task
 *                  hi_svp_src_img   *src1  Augend of the input source.Only the S32C1(s17q15) input format is supported.
 *                  hi_svp_src_img   *src2  Addend of the input source.Only the S32C1(s17q15) input format is supported.
 *                  hi_svp_dst_img   *dst   Output result of src1 multiply src2.
 *                  hi_ive_acc_ctrl  *ctrl  ctrl.
 ...
 *   Author       : Multimedia software (SVP) group
 */
hi_s32 hi_mpi_ive_image_dot(hi_ive_handle *handle, const hi_svp_src_img *src1, const hi_svp_src_img *src2,
    const hi_svp_dst_img *dst, const hi_ive_image_dot_ctrl *ctrl, hi_bool is_instant);
#ifdef __cplusplus
}
#endif
#endif /* HI_MPI_IVE_H */
