...
hi_s32 hi_mpi_awb_sensor_unreg_callback(hi_vi_pipe vi_pipe, const hi_isp_3a_alg_lib *awb_lib, hi_sensor_id sns_id);
...
hi_s32 hi_mpi_isp_set_color_sector_attr(hi_vi_pipe vi_pipe, const hi_isp_color_sector_attr *sector_attr);
hi_s32 hi_mpi_isp_get_color_sector_attr(hi_vi_pipe vi_pipe, hi_isp_color_sector_attr *sector_attr);
