...
#define HI_IVE_WARP_PERSPECTIVE_POINT_NUM OT_IVE_WARP_PERSPECTIVE_POINT_NUM
...
typedef ot_ive_warp_perspective_point_pair hi_ive_warp_perspective_point_pair;
typedef ot_ive_warp_perspective_points hi_ive_warp_perspective_points;
typedef ot_ive_warp_perspective_transform_ctrl hi_ive_warp_perspective_transform_ctrl;
typedef ot_ive_warp_perspective_ctrl hi_ive_warp_perspective_ctrl;
...
#define HI_IVE_ACC_MODE_INCREASE OT_IVE_ACC_MODE_INCREASE
#define HI_IVE_ACC_MODE_DECREASE OT_IVE_ACC_MODE_DECREASE
#define HI_IVE_ACC_MODE_INCREASE_MAP_255TO1 OT_IVE_ACC_MODE_INCREASE_MAP_255TO1
#define HI_IVE_ACC_MODE_BUTT OT_IVE_ACC_MODE_BUTT
typedef ot_ive_acc_mode hi_ive_acc_mode;
typedef ot_ive_acc_ctrl hi_ive_acc_ctrl;
#define HI_IVE_IMAGE_DOT_MODE_ROUND_INT OT_IVE_IMAGE_DOT_MODE_ROUND_INT
#define HI_IVE_IMAGE_DOT_MODE_BUTT OT_IVE_IMAGE_DOT_MODE_BUTT
typedef ot_ive_image_dot_mode hi_ive_image_dot_mode;
typedef ot_ive_image_dot_ctrl hi_ive_image_dot_ctrl;
#ifdef __cplusplus
}
#endif
