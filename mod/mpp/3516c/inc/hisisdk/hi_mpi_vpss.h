...
hi_s32 hi_mpi_vpss_set_grp_svc_param(hi_vpss_grp grp, const hi_vpss_svc_param *svc_param);
hi_s32 hi_mpi_vpss_get_grp_svc_param(hi_vpss_grp grp, hi_vpss_svc_param *svc_param);
...
hi_s32 hi_mpi_vpss_set_chn_ldc(hi_vpss_grp grp, hi_vpss_chn chn, const hi_ldc_attr *ldc_attr);
hi_s32 hi_mpi_vpss_get_chn_ldc(hi_vpss_grp grp, hi_vpss_chn chn, hi_ldc_attr *ldc_attr);

hi_s32 hi_mpi_vpss_set_chn_buf_wrap(hi_vpss_grp grp, hi_vpss_chn chn, const hi_vpss_chn_buf_wrap_attr *wrap_attr);
hi_s32 hi_mpi_vpss_get_chn_buf_wrap(hi_vpss_grp grp, hi_vpss_chn chn, hi_vpss_chn_buf_wrap_attr *wrap_attr);
...
hi_s32 hi_mpi_vpss_start_grp_stitch_luma_sync(hi_vpss_grp grp, const hi_stitch_luma_sync_param *param);
hi_s32 hi_mpi_vpss_stop_grp_stitch_luma_sync(hi_vpss_grp grp);

/* fd */
hi_s32 hi_mpi_vpss_get_chn_fd(hi_vpss_grp grp, hi_vpss_chn chn);

hi_s32 hi_mpi_vpss_set_grp_zoom_in_window(hi_vpss_grp grp, const hi_zoom_attr *zoom_attr);
hi_s32 hi_mpi_vpss_get_grp_zoom_in_window(hi_vpss_grp grp, hi_zoom_attr *zoom_attr);
#ifdef __cplusplus
}
#endif
#endif /* HI_MPI_VPSS_H */
