...
hi_s32 hi_mpi_dpu_rect_update_lut(const hi_dpu_rect_mem_info lut_mem[HI_DPU_RECT_MAX_PIPE_NUM],
    const hi_dpu_rect_lut_id rect_lut_id[HI_DPU_RECT_MAX_PIPE_NUM], hi_dpu_rect_grp rect_grp);
