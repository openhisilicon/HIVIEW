...
typedef struct {
    td_u32  blend_position; /* RW; blend position */
    td_u32  blend_range; /* RW; blend range */
} ot_blend_param;
...
typedef struct {
    ...
    td_s64  pmf_coef[OT_GDC_COMMON_COEF_NUM]; /* RW; PMF coefficient of gdc */
    td_s32  center_x_offset; /* RW; offset of x */
    td_s32  center_y_offset; /* RW; offset of y */
    td_u32  ratio;           /* RW: ratio of cylindrical projection */
