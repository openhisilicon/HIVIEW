...
typedef enum {
    ...
    DRV_TDE_COLOR_FMT_JPG_YCBCR422MBHP,   /* 44：SP422h(1*2)(像素宽度为偶数) */
    DRV_TDE_COLOR_FMT_JPG_YCBCR422MBVP,   /* 45：SP422V(2*1)(像素高度为偶数) */
    DRV_TDE_COLOR_FMT_MP1_YCBCR420MBP,    /* 46：SP420(cd hi像素宽高为偶数) */
    DRV_TDE_COLOR_FMT_MP2_YCBCR420MBP,    /* 47：SP420(cd hi像素宽高为偶数) */
    DRV_TDE_COLOR_FMT_MP2_YCBCR420MBI,    /* 48：SP420(cd hi像素宽高为偶数) */
    DRV_TDE_COLOR_FMT_JPG_YCBCR420MBP,    /* 49：SP420(cd hi像素宽高为偶数) */
    DRV_TDE_COLOR_FMT_JPG_YCBCR444MBP,    /* 50：SP444(cd hi像素宽高为偶数) */
