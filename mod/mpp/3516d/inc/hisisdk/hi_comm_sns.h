...
typedef struct HiISP_CMOS_SHARPEN_MANUAL_S
{
    ...
    HI_U8  u8RGain;                /* RW; Range: [0, 32]; Format:5.0;Sharpen Gain for Red Area*/
    HI_U8  u8BGain;                /* RW; Range: [0, 32]; Format:5.0;Sharpen Gain for Blue Area*/
...
typedef struct HiISP_CMOS_SHARPEN_AUTO_S
{
    ...
    HI_U8  au8RGain[ISP_AUTO_ISO_STRENGTH_NUM];                /* RW; Range: [0, 32]; Format:5.0;Sharpen Gain for Red Area*/
    HI_U8  au8BGain[ISP_AUTO_ISO_STRENGTH_NUM];                /* RW; Range: [0, 32]; Format:5.0;Sharpen Gain for Blue Area*/
