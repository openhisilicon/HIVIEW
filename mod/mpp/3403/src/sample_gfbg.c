...
static hi_s32 sample_bind_layer_to_vo(hi_vo_layer layer, hi_vo_dev dev)
{
    hi_s32 ret;
...
static hi_void *sample_gfbg_g3_clut(void *data)
{
    pthread_gfbg_sample_info *info = HI_NULL;
    struct fb_var_screeninfo var;
    struct fb_fix_screeninfo fix;
...
{
#if GFBG_BE_WITH_VO
    hi_vo_intf_type gfbg_vo_intf_type = vo_dev_info->vo_intf_type;
...
static hi_s32 sample_gfbg_standard_mode(vo_device_info *vo_dev_info)
{
    ...
    if (pthread_create(&g_gfbg_thread1, 0, sample_gfbg_pandisplay, (hi_void *)(&info1)) != 0) {
...
static hi_s32 sample_gfbg_dcmp(vo_device_info *vo_dev_info)
{
    hi_s32 ret;
    pthread_gfbg_sample_info info0;
    hi_vo_dev vo_dev = vo_dev_info->vo_dev;
...
static hi_s32 sample_gfbg_dcmp_argb8888(vo_device_info *vo_dev_info)
{
    hi_s32 ret;
    pthread_gfbg_sample_info info0;
    hi_vo_dev vo_dev = vo_dev_info->vo_dev;
...
int app_main(int argc, char *argv[])
{
    ...
    vo_dev_info.vo_intf_type = HI_VO_INTF_HDMI; /* default:HDMI or BT1120 */
    ...
    if ((argc > 2) && *argv[3] == '1') { /* 2 3 for alg */
        vo_dev_info.vo_intf_type = HI_VO_INTF_BT1120;
    }
