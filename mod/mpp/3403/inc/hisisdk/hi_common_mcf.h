...
#ifndef __HI_COMMON_MCF_H__
#define __HI_COMMON_MCF_H__
...
#define HI_MCF_RLUT_NUM OT_MCF_RLUT_NUM
#define HI_MCF_SLUT_NUM OT_MCF_SLUT_NUM
#define HI_MCF_NLUT_NUM OT_MCF_NLUT_NUM
#define HI_MCF_CHF_MAT_NUM OT_MCF_CHF_MAT_NUM
...
typedef ot_mcf_color_hf_proc_cfg hi_mcf_color_hf_proc_cfg;
typedef ot_mcf_hist_adj_cfg hi_mcf_hist_adj_cfg;
