...
#define HI_VI_CORRECTION_COEF_NUM OT_VI_CORRECTION_COEF_NUM
...
#define HI_VI_BIT_ALIGN_MODE_HIGH OT_VI_BIT_ALIGN_MODE_HIGH
#define HI_VI_BIT_ALIGN_MODE_LOW OT_VI_BIT_ALIGN_MODE_LOW
#define HI_VI_BIT_ALIGN_MODE_BUTT OT_VI_BIT_ALIGN_MODE_BUTT
typedef ot_vi_bit_align_mode hi_vi_bit_align_mode;
...
typedef ot_vi_fov_correction_attr hi_vi_fov_correction_attr;

#ifdef __cplusplus
}
#endif
#endif /* __HI_COMMON_VI_H__ */
