...
HI_S32 SAMPLE_SCENE_START_PREV(SCENE_PREV_S *pstScenePrev)
{
    ...
    pstScenePrev->stViConfig.astViInfo[s32WorkSnsId].stPipeInfo.aPipe[2]       = -1;
    pstScenePrev->stViConfig.astViInfo[s32WorkSnsId].stPipeInfo.aPipe[3]       = -1;
    ...
    astVpssChnAttr[pstScenePrev->VpssChn].enCompressMode              = enCompressMode;
    ...
    astVpssChnAttr[pstScenePrev->VpssChn].stFrameRate.s32SrcFrameRate = 30;
    astVpssChnAttr[pstScenePrev->VpssChn].stFrameRate.s32DstFrameRate = 30;
    ...
    //pstScenePrev->stVoConfig.enIntfSync   = VO_OUTPUT_1080P25;
	pstScenePrev->stVoConfig.enVoIntfType = VO_INTF_HDMI;
    ...
    /*vpss bind vo*/
    s32Ret = SAMPLE_COMM_VPSS_Bind_VO(pstScenePrev->VpssGrp, VPSS_CHN0, pstScenePrev->stVoConfig.VoDev, pstScenePrev->VoChn);
    if (HI_SUCCESS != s32Ret)
    {
