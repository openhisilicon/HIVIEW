...
#define HI_GPS_ACCURACY_LEVEL    3  /* dd/mm/ss */
#define HI_GPS_NUMBER_DIMENSION  2  /* numerator/denominator */
...
typedef struct hiGPS_INFO_S {
    /* GPS LatitudeRef Indicates whether the latitude is north or south latitude, 'N'/'S', default 'N' */
    HI_CHAR chGPSLatitudeRef;
    /*
     * GPS Latitude is expressed as degrees, minutes and seconds,
     * a typical format like "dd/1, mm/1, ss/1", default 0/1, 0/1, 0/1
     */
    HI_U32 au32GPSLatitude[HI_GPS_ACCURACY_LEVEL][HI_GPS_NUMBER_DIMENSION];
    /* GPS LongitudeRef Indicates whether the longitude is east or west longitude, 'E'/'W', default 'E' */
    HI_CHAR chGPSLongitudeRef;
    /*
     * GPS Longitude is expressed as degrees, minutes and seconds, a typical format
     * like "dd/1, mm/1, ss/1", default 0/1, 0/1, 0/1
     */
    HI_U32 au32GPSLongitude[HI_GPS_ACCURACY_LEVEL][HI_GPS_NUMBER_DIMENSION];
    /* GPS AltitudeRef Indicates the reference altitude used, 0 - above sea level,1 - below sea level default 0 */
    HI_U8 u8GPSAltitudeRef;
    /*
     * GPS AltitudeRef Indicates the altitude based on the reference u8GPSAltitudeRef,
     * the reference unit is meters, default 0/1
     */
    HI_U32 au32GPSAltitude[HI_GPS_NUMBER_DIMENSION];
} GPS_INFO_S;
