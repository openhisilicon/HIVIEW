...
typedef struct hiTDE2_BLEND_OPT_S {
    ...
    /* <Src1 blending mode. It is valid when eBlendCmd is set to TDE2_BLENDCMD_CONFIG. */
    TDE2_BLEND_MODE_E eSrc1BlendMode;
    /* <Src2 blending mode. t is valid when eBlendCmd is set to TDE2_BLENDCMD_CONFIG. */
