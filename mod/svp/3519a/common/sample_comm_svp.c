...
HI_S32 SAMPLE_COMM_SVP_LoadCoreBinary(SVP_DSP_ID_E enCoreId)
{
	...
	#if defined AMP
    HI_CHAR * aszBin[4][4] = {
    {"./dsp_bin/amp/dsp0/hi_sram.bin","./dsp_bin/amp/dsp0/hi_iram0.bin","./dsp_bin/amp/dsp0/hi_dram0.bin","./dsp_bin/amp/dsp0/hi_dram1.bin"},
    {"./dsp_bin/amp/dsp1/hi_sram.bin","./dsp_bin/amp/dsp1/hi_iram0.bin","./dsp_bin/amp/dsp1/hi_dram0.bin","./dsp_bin/amp/dsp1/hi_dram1.bin"},
    {"./dsp_bin/amp/dsp2/hi_sram.bin","./dsp_bin/amp/dsp2/hi_iram0.bin","./dsp_bin/amp/dsp2/hi_dram0.bin","./dsp_bin/amp/dsp2/hi_dram1.bin"},
    {"./dsp_bin/amp/dsp3/hi_sram.bin","./dsp_bin/amp/dsp3/hi_iram0.bin","./dsp_bin/amp/dsp3/hi_dram0.bin","./dsp_bin/amp/dsp3/hi_dram1.bin"}};
	#else
	HI_CHAR * aszBin[4][4] = {
    {"./dsp_bin/smp/dsp0/hi_sram.bin","./dsp_bin/smp/dsp0/hi_iram0.bin","./dsp_bin/smp/dsp0/hi_dram0.bin","./dsp_bin/smp/dsp0/hi_dram1.bin"},
    {"./dsp_bin/smp/dsp1/hi_sram.bin","./dsp_bin/smp/dsp1/hi_iram0.bin","./dsp_bin/smp/dsp1/hi_dram0.bin","./dsp_bin/smp/dsp1/hi_dram1.bin"},
    {"./dsp_bin/smp/dsp2/hi_sram.bin","./dsp_bin/smp/dsp2/hi_iram0.bin","./dsp_bin/smp/dsp2/hi_dram0.bin","./dsp_bin/smp/dsp2/hi_dram1.bin"},
    {"./dsp_bin/smp/dsp3/hi_sram.bin","./dsp_bin/smp/dsp3/hi_iram0.bin","./dsp_bin/smp/dsp3/hi_dram0.bin","./dsp_bin/smp/dsp3/hi_dram1.bin"}};
