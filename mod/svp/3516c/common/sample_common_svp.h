...
#define HI_SVP_NOTIFY_BOX_SCALE                 30
 ...
 * Start Vpss
 */
hi_s32 sample_common_svp_create_vb_start_vpss(hi_sample_svp_media_cfg *media_cfg);
/*
 * Stop Vpss
 */
hi_void sample_common_svp_destroy_vb_stop_vpss(hi_sample_svp_media_cfg *media_cfg);
/*
 * Send stream to venc
 */
hi_s32 sample_common_svp_venc_send_stream(const hi_sample_svp_switch *venc_switch,
    hi_venc_chn venc_chn, const hi_video_frame_info *frame);
