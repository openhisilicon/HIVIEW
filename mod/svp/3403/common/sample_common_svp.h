...
hi_s32 sample_common_svp_start_vi_vpss_venc_vo(sample_vi_cfg *vi_config,
    hi_sample_svp_switch *switch_ptr, hi_pic_size *ext_pic_size_type);

/* function : Stop Vi/Vpss/Venc/Vo */
hi_void sample_common_svp_stop_vi_vpss_venc_vo(sample_vi_cfg *vi_config,
